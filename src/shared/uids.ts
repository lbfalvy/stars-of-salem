...
export function getUid(): string {
    if (salt == "") throw new Error("Please seed the UID generator before using it!");
    if (hash == null) throw new Error("Please assign a platform-dependent secure hash function!");
